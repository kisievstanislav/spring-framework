...
//        return getAllEmployees().stream()     100 employees
//                .filter(employee -> employee.getSalary() > 6000)  //   100    // 100 - 25 = 75
//                .filter(employee -> employee.getSalary() < 7000)  //   75
//                .collect(Collectors.toList());                    //   175

        return getAllEmployees().stream()       // 100
                .filter(employee -> employee.getSalary() > 6000 && employee.getSalary() < 7000)     // 100
                .collect(Collectors.toList());
